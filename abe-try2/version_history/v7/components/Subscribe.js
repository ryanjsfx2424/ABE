...
export default function Subscribe({conversions, abe_guild_data_db, guild_id, guild_name}) {
  ...
  const MonthTexts = ["1 Month", "3 Months (5% off)", "6 Months (10% off)", "9 Months (15% off)", "12 Months (20% off)", "Trial"]
  const MonthFractions = [1, 0.95, 0.9, 0.85, 0.8, 0]
  const MonthNums = [1, 3, 6, 9, 12, 0]
  ...
  // type is usdc or eth (atm)
  // name is basic, standard, or premium
          ...
          {!isSubscribed ?
              ...
              <div className=' grid lg:grid-cols-3 gap-8 grid-cols-1 pb-64'>
                  <Menu>  
                          ...
                          <MenuList style={{backgroundColor: "#25324C"}} className="text-white">
                  ...
                  <Menu>
                          ...
                          <MenuList style={{backgroundColor: "rgb(59 130 246)"}} className="text-white">
                              {MonthTexts.map((monthText) => (
                                <MenuItem key={monthText} onClick={() => {menuItemHandler(monthText)}}>{monthText}</MenuItem>
                              ))}
                          </MenuList>
